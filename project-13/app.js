...
window.onload = () => {
    ...
    if (customColorsString) {
        ...
        updatePaletteColor(document.querySelector('.custom-preset-container'), customColor)
    }  
}
...
function main() {
    ...
    bgUploadField.addEventListener('change', handleUpload(previewBg,bgRemoveBtn,bgController))
    bgRemoveBtn.addEventListener('click', handleRemove(previewBg, bgRemoveBtn, bgController))
    document.getElementById('bgSize').addEventListener('change', handleBgController(previewBg))
    document.getElementById('bgRepeat').addEventListener('change', handleBgController(previewBg))
    document.getElementById('bgPosition').addEventListener('change', handleBgController(previewBg))
    document.getElementById('bgAttachment').addEventListener('change', handleBgController(previewBg))
...
function handleBgController(previewBg) {
    ...
    previewBg.style.backgroundSize = document.getElementById('bgSize').value
       ...
       previewBg.style.backgroundPosition = document.getElementById('bgPosition').value
       document.body.style.backgroundSize = document.getElementById('bgSize').value
       document.body.style.backgroundRepeat = document.getElementById('bgRepeat').value
       document.body.style.backgroundPosition = document.getElementById('bgPosition').value
       document.body.style.backgroundAttachment = document.getElementById('bgAttachment').value
    }
}
